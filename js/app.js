(() => {
    ...
    function initSliders() {
        if (document.querySelector(".articles-block__slider")) new Swiper(".articles-block__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            if (document.querySelector(swiperClass)) {
                ...
                const checker = function() {
                    if (breakpoint.matches) return enableSwiper(swiperClass, swiperSettings); else {
                        if (swiper !== void 0 && typeof swiper.destroy === "function") swiper.destroy(true, true);
                        return;
                    }
                };
        ...
        resizableSwiper("(max-width: 549.98px)", ".cooperation__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
